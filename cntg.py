...
██║░╚═╝░██║███████╗░░░██║░░░██║░░██║
╚═╝░░░░░╚═╝╚══════╝░░░╚═╝░░░╚═╝░░╚═╝
 selamat datang {kk}{n}{P}, script by {kk}rochmat basuki{P} limited user~recode by:chy""")
def logo2():
	return str(f"""  
███╗░░░███╗███████╗████████╗░█████╗░
████╗░████║██╔════╝╚══██╔══╝██╔══██╗
...
██║░╚═╝░██║███████╗░░░██║░░░██║░░██║
╚═╝░░░░░╚═╝╚══════╝░░░╚═╝░░░╚═╝░░╚═╝
 selamat datang {kk}user{P}, script by {kk}rochmat basuki{P} limited user ~recode by:chy""")
...
def ua_rozh():
	rr = random.randint
	rc = random.choice
	A = f"Mozilla/5.0 (Linux; arm_64; Android 10; {str(rr(2,10))};  SM-G960F) {str(rr(3,9))} AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,100))}.80.0.3987.122 YaBrowser/20.3.0.276.00 TA/5.1 Mobile SA/1 Safari/537.36" #ANDROID UCB
	B = f"Mozilla/5.0 (Linux; Android 5.1;  {str(rr(2,10))}; HUAWEI CUN-L01) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.116 Mobile Safari/537.36" #ANDROID
	C = f"Mozilla/5.0 (Linux; Android 7.1.1; {str(rr(2,10))}; Aquaris U Lite) {str(rr(3,9))} AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,100))}.81.0.4044.111 Mobile Safari/537.36" #ANDRID YANDX
	D = f"Mozilla/5.0 (Linux; U; Android 10; {str(rr(2,10))}; Mi A2 Lite Build/QKQ1.191002.002; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/{str(rr(11,99))}.81.0.4044.138 Mobile Safari/537.36 OPR/{str(rr(11,99))}.58.0.2254.58441"
	E = f"Mozilla/5.0 (Linux; Android 6.0.1; {str(rr(2,10))}; D6503 Build/23.5.A.1.291) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.157 Mobile Safari/537.36 OPR/{str(rr(2,20))}.53.1.2569.142848" #ANDROID ORERA MINI
	F =  f"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:2.0b7) Gecko/20101111 Firefox/4.0b7 " #WINDOWS OPERA
	baz = rc([A,B,C,D,F])
